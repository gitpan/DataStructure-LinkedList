...
DataStructure::LinkedList::Cell - a Cell of the LinkedList.
...
accessor for next cell of the LinkedList.
...
Each cell is lined in the sorted state at the value in DataStructure::LinkedList. it's used for the sorting.
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc DataStructure::LinkedList::Cell
...
1; # End of DataStructure::LinkedLis::Cell
